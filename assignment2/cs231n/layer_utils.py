...
def affine_norm_relu_forward(x, w, b, gamma, beta, bn_param, dropout_param):
    ...
    if dropout_param != 1:
      out, drop_cache = dropout(x, dropout_param)

    cache = (bn_cache, fc_cache, relu_cache, drop_cache)
    return out, cache

def affine_norm_relu_backward(dout, cache):

  bn_cache, fc_cache, relu_cache, drop_cache = cache
